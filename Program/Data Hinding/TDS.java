    ...
    public static void hideSecretImage(File coverImage, File fPrint, File stegoCover) {
        ...
        for (int reg = 1; reg <= 4; reg++) {
            for (int seg = 1; seg <= 4; seg++) {
                ...
                int startingFragIndex = EmbedData.startingFragIndex;
                int matrixInterval = EmbedData.matrixInterval;
    ...
    public static void extractSecretImage(File stegoCover, int size, String extractionPath) {
        ...
        for (int reg = 1; reg <= 4; reg++) {
            for (int seg = 1; seg <= 4; seg++) {
                ...
                int startingFragIndex = ExtractData.startingFragIndex;
                int matrixInterval = ExtractData.matrixInterval;
